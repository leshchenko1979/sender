...
from account.account import AccountCollection
...
def account_dict():
    return {
        "account1": Account(raises = RuntimeError),
        "account2": Account(),
    }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("raise", RuntimeError, "error_path_raise"),
        ("revalidate", RuntimeError, "happy_path_revalidate"),
    ],
)
